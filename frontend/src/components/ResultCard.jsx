    ...
    <div className="result-card">
      ...
      <div className="result-footer">
        ...
        <p className="result-note">
          * Estimates are based on current Portless rates as of {new Date().toLocaleDateString('en-US', { month: 'long', day: 'numeric', year: 'numeric' })}. Talk to your Portless logistics consultant to learn more.
        </p>
      </div>
